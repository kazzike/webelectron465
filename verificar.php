	...
	if($fila > 0){
		...
		$cuerpo = "				
			...
			<br><br>
				...
				traves de MRW Oficina Paseo de la Feria Código Agencia: 1401000 Dirección: AV. PASEO DE LA FERIA, EDIF. RES. EL PASEO, 
	  ...
	  if(!$mail->Send()) {
		...
		echo '<br><br><center><H1>Su afiliacion ha sido procesada.
			Por favor has click en el enlace que enviamos a tu correo ' . $_GET['c'] . ', a fines de verificar su cuenta
